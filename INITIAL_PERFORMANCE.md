...
Method: each run closed the app with `luna://com.webos.applicationManager/closeByAppId`, waited briefly, launched with `luna://com.webos.applicationManager/launch`, waited ~4.2 s, then captured `/tmp/com.sachk.tern.log`. The app was closed again after the measurement loop.
...
| Artifact | Size / count |
|---|---:|
| `build/com.sachk.tern_0.2.1_arm.ipk` | 30.90 MiB |
