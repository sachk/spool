...
FocusScope {
    ...
    ColumnLayout { anchors.fill: parent; anchors.margins: Metrics.pageMargin(width); spacing: 14
        SectionHeader { Layout.fillWidth: true; title: "Search"; detail: "/ focuses search · OK opens keyboard" }
