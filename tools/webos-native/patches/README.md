...
Qt 6.11.0 host/target prefixes consumed by `build-ipk.sh`.

`qtbase-6.11.0-webos-qstorageinfo-linux.patch`
...
`qtbase-6.11.0-webos-no-cursor-set.patch`
...
`qtwayland-6.11.0-webos-wayland-version.patch`
