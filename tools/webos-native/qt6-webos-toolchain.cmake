...
if(EXISTS "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-gcc-ar")
    set(WEBOS_AR "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-gcc-ar")
else()
    set(WEBOS_AR "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-ar")
endif()
if(EXISTS "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-gcc-ranlib")
    set(WEBOS_RANLIB "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-gcc-ranlib")
else()
    set(WEBOS_RANLIB "${WEBOS_TOOLCHAIN_BINDIR}/arm-webos-linux-gnueabi-ranlib")
endif()
set(CMAKE_AR "${WEBOS_AR}")
set(CMAKE_RANLIB "${WEBOS_RANLIB}")
set(CMAKE_C_COMPILER_AR "${WEBOS_AR}")
set(CMAKE_CXX_COMPILER_AR "${WEBOS_AR}")
set(CMAKE_C_COMPILER_RANLIB "${WEBOS_RANLIB}")
set(CMAKE_CXX_COMPILER_RANLIB "${WEBOS_RANLIB}")
