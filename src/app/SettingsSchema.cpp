...
namespace {
    ...
    constexpr SettingChoice kSubtitleImageColorModeChoices[] = { { "keep", "Keep original colours" },
        { "match", "Match text colour" }, { "tint", "Tint toward text colour" } };
...
const QVector<SettingSpec>& settingSpecs()
{
    ...
    static const QVector<SettingSpec> specs {
        ...
        { "subtitles/styling", "Subtitle Appearance", "Style Policy",
            "Automatic respects ASS/SSA styles and applies your choices to plain text. Bitmap subtitles follow size, "
            "position, and colour, but keep their own font.",
            SettingType::Select, "Auto", kSubtitleStylingChoices, countOf(kSubtitleStylingChoices), 0, 0, 1, 0, "",
            SettingTarget::SubtitleStyling, SettingNormalizer::SubtitleStyling, true, true, SettingLevel::Advanced },
        { "subtitles/textSize", "Subtitle Appearance", "Text Size", "Base size for text subtitles only",
            SettingType::Select, "", kSubtitleTextSizeChoices, countOf(kSubtitleTextSizeChoices), 0, 0, 1, 0, "",
        ...
        { "subtitles/scalePercent", "Subtitle Appearance", "Overall Scale",
            "Scales all plain text and bitmap subtitles, and authored ASS when geometry override is enabled",
        ...
        { "subtitles/imageColorMode", "Subtitle Appearance", "Image Subtitles",
            "PGS and VobSub carry their own colours; recolour them to match your text colour", SettingType::Select,
            "keep", kSubtitleImageColorModeChoices, countOf(kSubtitleImageColorModeChoices), 0, 0, 1, 0, "",
            SettingTarget::SubtitleImageColorMode, SettingNormalizer::Choice, true, true, SettingLevel::Advanced,
        ...
        { "subtitles/font", "Subtitle Appearance", "Font",
            ...
            "", kSubtitleFontChoices, countOf(kSubtitleFontChoices), 0, 0, 1, 0, "", SettingTarget::SubtitleFont,
        ...
        { "subtitles/dropShadow", "Subtitle Appearance", "Outline / Shadow",
            ...
            countOf(kSubtitleDropShadowChoices), 0, 0, 1, 0, "", SettingTarget::SubtitleDropShadow,
        ...
        { "subtitles/verticalPositionPercent", "Subtitle Appearance", "Vertical Position - Bottom to Top",
            "At 100% keeps authored ASS and image placement; otherwise moves normal bottom image dialogue, or every "
            "authored subtitle event when geometry override is enabled",
            SettingType::Slider, "100", nullptr, 0, 0, 100, 1, 0, "%", SettingTarget::SubtitleVerticalPosition,
            SettingNormalizer::IntRange, true, false, SettingLevel::Advanced },
        { "subtitles/alwaysOverridePositionAndSize", "Subtitle Appearance",
            "Always Override Subtitle Position and Size",
            "Apply Overall Scale and Vertical Position to authored ASS, PGS, and VobSub subtitles instead of keeping "
        ...
        { "subtitles/dimInHdr", "Subtitle Appearance", "Comfortable HDR White",
            ...
            nullptr, 0, 0, 0, 1, 0, "", SettingTarget::SubtitleDimInHdr, SettingNormalizer::Bool, true, false,
        ...
        { "subtitles/hdrBrightnessPercent", "Subtitle Appearance", "HDR Paper White",
            ...
            100, 5, 0, "%", SettingTarget::SubtitleHdrBrightness, SettingNormalizer::IntRange, true, false,
