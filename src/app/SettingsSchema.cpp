...
namespace {
    ...
    constexpr SettingChoice kSubtitleImageColorModeChoices[]
        = { { "keep", "Keep their colours" }, { "match", "Match my colour" }, { "tint", "Tint toward my colour" } };
...
const QVector<SettingSpec>& settingSpecs()
{
    ...
    static const QVector<SettingSpec> specs {
        ...
        selectSpec("subtitles/styling", "Subtitle Appearance", "Style",
            ...
            .advanced(),
        selectSpec("subtitles/textSize", "Subtitle Appearance", "Text size", "Text subtitles only", "",
            kSubtitleTextSizeChoices, SettingTarget::SubtitleTextSize)
            .advanced(),
        sliderSpec("subtitles/scalePercent", "Subtitle Appearance", "Overall scale", "Image subtitles too", "100", 50,
            200, 5, "%", SettingTarget::SubtitleScale)
            .advanced(),
        sliderSpec("subtitles/verticalPositionPercent", "Subtitle Appearance", "Vertical position",
            "Higher values move subtitles up the screen", "100", 0, 100, 1, "%",
        ...
        selectSpec("subtitles/textBackground", "Subtitle Appearance", "Background", "", "transparent",
            ...
            .advanced(),
        selectSpec("subtitles/imageColorMode", "Subtitle Appearance", "Image subtitle colour",
            "PGS and VobSub arrive with colours of their own", "keep", kSubtitleImageColorModeChoices,
            SettingTarget::SubtitleImageColorMode)
            .advanced(),
        selectSpec("subtitles/bitmapSmoothing", "Subtitle Appearance", "Image subtitle edges", "", "soft",
            kSubtitleBitmapSmoothingChoices, SettingTarget::SubtitleBitmapSmoothing)
            .advanced(),
        toggleSpec("subtitles/dimInHdr", "Subtitle Appearance", "Dim subtitles in HDR",
            "Stops white text glaring against HDR video", true, SettingTarget::SubtitleDimInHdr)
            .advanced()
            .duringHdrPlayback(),
        sliderSpec("subtitles/hdrBrightnessPercent", "Subtitle Appearance", "HDR subtitle brightness", "", "75", 40,
            100, 5, "%", SettingTarget::SubtitleHdrBrightness)
            .advanced()
            .duringHdrPlayback()
            .whenSetTo("subtitles/dimInHdr", "true"),
